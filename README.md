...
```
# OUTPUT:
![alt text](<Screenshot 2025-05-02 105300.png>)
...
int main() {
    ...
    printf("Minimum fraction value: %f\n", result);

    return 0;
}
```
## OUTPUT:
![alt text](<Screenshot 2025-05-02 110445.png>)
...
```
## OUTPUT:
![alt text](<Screenshot 2025-05-02 110723.png>)
